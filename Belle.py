    ...
    while True:
        ...
        if len(nSlice) == N:
            ...
            #If [LOW, HIGH] detected
                ...
                yChain += 1
                xChain = 0
                if (yChain > 5) and biFlag and (total < 10) and timedCounter < counter:
                    reps += 1
                    #Sets vibration on
                    GPIO.output(pin, True)
                    #Vibration on timer
                    vibCounter = counter + 30
                    #Disable rep timer
                    timedCounter = counter + 200
                    biFlag = False
...
#Will be sent via button on server
   ...
   # jsonString = '[{"dumbbell_id":"58dfca3f1d3448278f2fc68a","workout":"test1","reps":10,"form":20}]'
    ...
    os.system('python2.7 Server_test.py "58dfca3f1d3448278fc68a" "button" 10 20' )
